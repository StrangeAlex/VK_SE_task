...
import numpy as np
from models_small.transformer import TransformerBlock
from utils import LearnableSigmoid2d
from pesq import pesq
from joblib import Parallel, delayed

from models_small.cross_attention import CrossAttentionBlock
...
class MPNet(nn.Module):
    def __init__(self, h, num_shared_tsblocks=2, num_branch_tsblocks=2):
        ...
        self.shared_ts_transformer = nn.ModuleList([
            MambaBlock(h) for _ in range(num_shared_tsblocks)
        ])
